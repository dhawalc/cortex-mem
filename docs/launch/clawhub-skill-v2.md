# ClawHub v2 listing draft

**Review status:** draft for Dhawal. After review, copy the fenced content below
to `packaging/clawhub/aoms/SKILL.md`, validate the package, and publish it as
version 2.0.0. This document is not the publishable package.

...
def import_command(source: Path, batch_size: int, data_dir: Path | None) -> None:
    ...
    importer = JSONLImporter(
        _repository(settings), batch_size=batch_size, progress=progress
    )

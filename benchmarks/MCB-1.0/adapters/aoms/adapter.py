"""MCB-1.0 adapter for the real AOMS application layer."""
...
ADAPTER_INFO = {
    ...
    "system": "AOMS",
    "translation_policy": "explicit instructions declare replacement; otherwise observations append",
    "version": "MCB-1.0-reference-1",
}
